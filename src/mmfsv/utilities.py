...
from mmfsv.bed2image import trans2img
import torch
import torchvision
...
# parallel
def preprocess(bam_path, chromosome, chr_len, data_dir, num_processes):

    return trans2img(bam_path, chromosome, chr_len, data_dir, num_processes)
