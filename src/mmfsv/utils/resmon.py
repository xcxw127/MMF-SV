"""
Resource monitoring utilities (currently memory) for MMFSV
"""
import logging
import os
import time
...
log = logging.getLogger('mmfsv.ResourceMonitor')
...
class ResourceMonitor:
    ...
    def __init__(self, config: MMFSVConfig):
        ...
        try:
            ...
            logging.getLogger('mmfsv.dependencies').warning(f'Dependency psutil not available - resource monitoring is disabled.')
            self._process = None
            self._workers = {}
        else:
